function Strings( config ) {
	...
	const values = {
		...
		en: {
			...
			'sidebar/scene/imageUpload': 'Image',
			'sidebar/scene/loadImage': 'Load Image',
			...
			'sidebar/properties/event': 'Evento',
			...
			'sidebar/object/image': 'Image',
			'sidebar/object/replaceTexture': 'Replace Texture',
			'sidebar/object/opacity': 'Opacity',
